...
#
# at the moment i'm checking with two local folders.......
#
...
@SiteFolder = sort(qw/CSQ CSS CSA RDLi RDLm Rng STAT Wave Waves WVLM WVLS/);
...
my $log_out = "/Volumes/HDR/HFR_Archive/Logs/Archiver/PERL/hd2CenSite/hd2CenSite";
#=====================================================
#=====================================================
